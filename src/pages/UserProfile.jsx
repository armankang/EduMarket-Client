...
import { CustomButton, ProjectCard, TextInput, Loading } from "../components";
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea
                        ...
                        cols={6}
                        {...register("about", {
                          required: "Write a little bit about you.",
                        })}
...
const UserProfile = () => {
  ...
  if (isLoading) {
    return <Loading />; /*loading component not made yet */
  }
    ...
    <div className="container mx-auto p-5">
      <div className="">
          ...
          {user?.accountType === undefined && info?._id === user?._id && (
            <div className="flex items-center justify-center py-5 md:py-0 gap-4">
              <CustomButton
                ...
                iconRight={<FiEdit3 />}
                containerStyles={
                  "py-1.5 px-3 md:px-5 focus:outline-none bg-blue-600 hover:bg-blue-700 text-white rounded text-sm md:text-base border border-blue-600"
                }
              />
        ...
        <div className="w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm">
          ...
          <p className="flex gap-1 items-center px-3 py-1 text-slate-600 rounded-full">
            <IoMdInformationCircleOutline /> {info?.about ?? "No Information"}
          </p>
      ...
      <div className="w-full mt-20 flex flex-col gap-2">
        ...
        <div className="flex flex-wrap gap-3">
          {info?.projectPosts?.map((job, index) => {
            const data = {
              name: info?.name,
              email: info?.email,
            ...
            return <ProjectCard job={data} key={index} />;
          })}
        </div>
      </div>
      <UserForm open={openForm} setOpen={setOpenForm} />
    </div>
  );
};
